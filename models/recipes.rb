def recipes(pancakes, grilledcheese, pasta)
  recipes = [:bananapancakes => "#{pancakes}", :pestogrilledcheese => "#{grilledcheese}".chomp, :garliclemonshrimppasta => "#{pasta}".chomp]
  puts "#{recipes}"
end

@image = "images/imgres-1.jpg"
...
#
# grilledcheese = "Prep time: 5 mins
# Cook time:  10 mins
# Ready in: 15 mins
# Ingredients:
...
recipes(pancakes, grilledcheese, pasta)
