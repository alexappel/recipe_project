...
def recipes(meal, difficulty)
  recipes = {
    ...
    :dessert => [{:name=>"Ice Cream Sandwich", :imgaddress=>"images/ice_cream_sandwich_recipe.png"}, {:name=>"Flourless Chocolate Cake", :imgaddress=>"images/flourless_chocolate_cake_recipe.png"}, {:name=>"Macarron", :imgaddress=>"images/macarron_recipe.png"}]
  }
